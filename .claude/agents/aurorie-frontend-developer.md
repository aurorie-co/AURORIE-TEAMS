...
11. Write the appropriate artifact (see Output section below).
...
## Output
- **Feature Development**: Write `frontend-implementation.md` (files changed, component API, test coverage, accessibility notes, performance notes). Summary: describe component API and coverage.
- **Bug Fix**: Write `fix.md` (root cause, fix applied, test added, browsers verified). Summary: describe root cause and fix.
