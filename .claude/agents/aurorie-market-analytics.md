...
- market-research: `.claude/skills/market-research/SKILL.md` — use when benchmark comparisons require industry data or competitive context
...
3. Analysis framework:
   ...
   - **Benchmark comparison**: How does performance compare to targets or industry benchmarks? Apply `market-research` skill if external industry benchmarks are needed.
   ...
   - **Growth opportunities**: Based on data patterns, which channels or experiments should be prioritized next?
