...
assert_file_exists "aurorie-design-lead.md installed"        ".claude/agents/aurorie-design-lead.md"
assert_file_exists "aurorie-design-system.md installed"      ".claude/agents/aurorie-design-system.md"
assert_file_exists "aurorie-design-brand.md installed"       ".claude/agents/aurorie-design-brand.md"
assert_file_exists "design workflow installed"               ".claude/workflows/design.md"
assert_file_contains "design routing in routing.json"        ".claude/routing.json" '"design"'
